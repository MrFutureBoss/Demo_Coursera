  ...
  return (
    <div>
      <Link
        href={
          course.id
            ? `/course/${urlToHyphenated(course?.topic_name || "")}-${
                course.id
              }`
            : "#"
        }
        ...
        >
          {!loading && (
            <>
              ...
              >
                <p className="w-fit">{course.topic_name}</p>
                <span>
                  {
                    <CustomTooltip
                      title="This is course have certificate"
                      children={<Award size="24px" color="gold" />}
                    />
                  }
                </span>
              </div>
              ...
              <div
                ...
                dangerouslySetInnerHTML={renderHTML(
                  showLess(course?.description || "", 100)
                )}
              ></div>
